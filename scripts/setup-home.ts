...
const COLLECTIONS = [
  {
    ...
    description:"Los mejores SUV eléctricos e híbridos con 7 asientos disponibles en Chile. Precio negociado, entrega con vendedor oficial.",
...
async function main() {
  ...
  if (existingPublished) {
    ...
    await client.createOrReplace({
      ...
      heroSubtitle:         "Negociamos con nuestra red de vendedores oficiales y te traemos la mejor oferta del mercado en 24 horas. Si no ahorras, te devolvemos el dinero.",
