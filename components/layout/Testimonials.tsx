...
const DEFAULT_TESTIMONIALS: TestimonialData[] = [
  ...
  { name: "Pablo V.",     car: "BYD Tang Pro",   carSlug: "byd-tang",      savings: "$6.100.000", rating: 5, imageUrl: "/images/testimonial-byd-tang.webp",     personImageUrl: "/images/testimonial-person-3.jpg", quote: "Para un auto de ese precio esperaba un proceso largo. Todo lo contrario: oferta en 48 horas, sin pisar una sola sucursal. El ahorro en un auto así es muy significativo." },
];
